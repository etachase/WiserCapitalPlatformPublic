    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="tab_details">
            ...
            <div class="form-group">
                ...
                {!! Form::input('password', 'password', isset($random_password) ? $random_password : "",  ['class' => 'form-control']) !!}
            </div>

            <div class="form-group">
                {!! Form::label('password_confirmation', trans('admin/users/general.columns.password_confirmation')) !!}
				{!! Form::input('password', 'password_confirmation', isset($random_password) ? $random_password : "",  ['class' => 'form-control']) !!}
            </div>
            
            <div class="form-group">
                {!! Form::label('company_id', trans('admin/users/general.columns.company')) !!}
                {!! Form::select('company_id', $companies , $user->company_id, ['class' => 'form-control', 'placeholder' => 'Select a company...']) !!}
            ...
            <div class="form-group">
                <div class="checkbox">  
                    <label>
                        ...
                        @else
                            {!! Form::checkbox('enabled', '1', isset($user->enabled) ? $user->enabled : 1) !!} {!! trans('general.status.enabled') !!}
                        @endif
                    </label>
                </div>
            </div>
