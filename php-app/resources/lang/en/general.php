...
return [
    ...
    'error'              => [
        ...
        'non-authorized'        => 'You are not authorized to access this module',
        'session-timeout'       => 'Session Expired - Please login to continue',
    ],
    ...
    'audit-log'           => [
        ...
        'msg-registration-attempt'     => 'Registration: :email.',
        'msg-account-created-login-in' => 'Registration successful, account created, login in: :email.',
        'msg-account-created-disabled' => 'Registration successful, account created but *disabled*: :email.',
    ],
