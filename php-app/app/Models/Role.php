...
class Role extends EntrustRole {
    ...
    /*
     * #################### Take Note ###################################
     * The following constants are mapped from the roles module, Please ensure
     * that the names match in module and here. 
     */
    const TYPE_INVESTOR = "Investors";
    const TYPE_SOLAR_INTEGRATOR = "solar-installer";
    const TYPE_HOST_FACILITIES = "Host Facilities";
